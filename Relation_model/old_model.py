...
class FCOutputModel(nn.Module):
    def __init__(self, outFeatureChannel):
        ...
        self.fc2 = nn.Linear(outFeatureChannel, outFeatureChannel)
...
class RN(nn.Module):
    def __init__(self, batch_size, num_objects, vocab_size, embedding_size=256, hidden_size=512, padding_idx = padding_idx,
                 dropout_ratio = 0.0, featureChannel=5, outFeatureChannel=2048, dropout= True):
        ...
        self.g_fc2 = nn.Linear(outFeatureChannel, outFeatureChannel)
        self.g_fc3 = nn.Linear(outFeatureChannel, outFeatureChannel)
        self.g_fc4 = nn.Linear(outFeatureChannel, outFeatureChannel)
